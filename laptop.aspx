<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="laptop.aspx.cs" Inherits="Electronic_store.laptop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:electronicStoreConnectionString %>" SelectCommand="SELECT [Pid], [Pname], [Pdesc], [Pimage], [Pprice] FROM [laptop]"></asp:SqlDataSource>
