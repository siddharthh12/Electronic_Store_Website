<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="headphone.aspx.cs" Inherits="Electronic_store.headphone" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:electronicStoreConnectionString %>" SelectCommand="SELECT [Pid], [Pname], [Pdesc], [Pimage], [Pprice] FROM [headphone]"></asp:SqlDataSource>
